...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv_title;
    CardView btn_run_foodlens, btn_nearby, behealt,btn_camera;
    ListView listview ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_camera = (CardView) findViewById(R.id.btn_run_camera);
        ...
        btn_run_foodlens = (CardView) findViewById(R.id.btn_run_foodlens);
        ...
        behealt = (CardView) findViewById(R.id.behealt);
        behealt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v){
                Intent moveIntent = new Intent(MainActivity.this, ListFood.class);
                startActivity(moveIntent);
            } });
        btn_nearby = (CardView) findViewById(R.id.nearby);
